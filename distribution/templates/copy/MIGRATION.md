...
- **从旧 marketplace 单独安装过文风分析、公众号发布或品牌工具：** 这些入口已移出旧目录。需要继续使用时，从新工具箱下载对应完整单项，保留本地修改，再通过客户端卸载旧的对应插件，避免重复。新工具箱不会自动迁移安装记录。

独立下载：

- [文风分析 ZIP](https://github.com/chestnutzoe/chestnut-skills/releases/latest/download/chestnut-style-analyzer.zip)
- [公众号草稿发布 ZIP](https://github.com/chestnutzoe/chestnut-skills/releases/latest/download/chestnut-wechat-publisher.zip)
- [其他工具与完整工具箱](https://github.com/chestnutzoe/chestnut-skills)

如果希望继续使用文风分析或公众号发布，请先取得对应单项包，再更新原来的组合插件，避免工作中断。
